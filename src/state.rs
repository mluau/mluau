...
impl Lua {
    ...
    /// Removes any thread creation, collection, or state change callbacks previously set by
    /// [`Lua::set_thread_creation_callback`], [`Lua::set_thread_collection_callback`], or [`Lua::set_thread_state_change_callback`].
    ///
